...
[![CI](https://github.com/Via-Vitae/viavitae-landing-funeral-services/actions/workflows/ci.yml/badge.svg)](https://github.com/Via-Vitae/viavitae-landing-funeral-services/actions/workflows/ci.yml)
[![Compliance](https://github.com/Via-Vitae/viavitae-landing-funeral-services/actions/workflows/compliance-check.yml/badge.svg)](https://github.com/Via-Vitae/viavitae-landing-funeral-services/actions/workflows/compliance-check.yml)
[![CodeQL](https://github.com/Via-Vitae/viavitae-landing-funeral-services/actions/workflows/codeql.yml/badge.svg)](https://github.com/Via-Vitae/viavitae-landing-funeral-services/actions/workflows/codeql.yml)
...
`viavitae-landing-funeral-services` is the single source of truth for how a ViaVitae repository looks.
...
gh repo create Via-Vitae/viavitae-<name> \
  --template Via-Vitae/viavitae-landing-funeral-services \
  --private \
...
cd viavitae-<name>
git remote add upstream git@github.com:Via-Vitae/viavitae-landing-funeral-services.git
```
...
Every ViaVitae repository is generated from `viavitae-landing-funeral-services`. Governance files are not
